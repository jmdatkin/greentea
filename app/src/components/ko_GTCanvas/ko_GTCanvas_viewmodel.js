...
import GTAppViewModel from '../ko_GTApp/ko_GTApp_viewmodel';



const GTCanvasViewModel = function() {
    this.canvas = $("#GTCanvas_canv");
    this.ctx = this.canvas.getContext('2d');

};

GTCanvasViewModel.prototype.clear = function() {
    this.ctx.clearRect(0,0,this.width,this.height);
};

GTCanvasViewModel.prototype.drawGrid =  function (store, size) {
...
GTCanvasViewModel.prototype.drawAdaptiveGrid = function (store) {
        ...
        this.drawGrid(store, scaledUnitSize);

        ctx.lineWidth = 1;
        ctx.strokeStyle = majorColor;
        this.drawGrid(store, majorUnitSize);

        ctx.lineWidth = 1;
        ctx.strokeStyle = mMajorColor;
        this.drawGrid(store, majorMajorUnitSize);
    };
...
export default GTCanvasViewModel;